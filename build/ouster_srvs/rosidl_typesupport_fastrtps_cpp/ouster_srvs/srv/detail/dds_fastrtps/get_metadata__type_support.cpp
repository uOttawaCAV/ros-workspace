...
#include "ouster_srvs/srv/detail/get_metadata__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ouster_srvs::srv::GetMetadata_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ouster_srvs::srv::GetMetadata_Request *>(
    untyped_ros_message);
...
{
  return &ouster_srvs::srv::typesupport_fastrtps_cpp::_GetMetadata_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const ouster_srvs::srv::GetMetadata_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ouster_srvs::srv::GetMetadata_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ouster_srvs::srv::typesupport_fastrtps_cpp::_GetMetadata_Response__handle;
}
...
{
  return &ouster_srvs::srv::typesupport_fastrtps_cpp::_GetMetadata__handle;
}
