...
bool sbg_driver__msg__sbg_imu_short__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sbg_driver.msg._sbg_imu_short.SbgImuShort", full_classname_dest, 41) == 0);
  }
  sbg_driver__msg__SbgImuShort * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SbgImuShort */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sbg_driver.msg._sbg_imu_short");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgImuShort");
