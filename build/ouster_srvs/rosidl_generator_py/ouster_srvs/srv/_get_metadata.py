...
class Metaclass_GetMetadata_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ouster_srvs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetMetadata(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ouster_srvs.srv import _get_metadata
...
class GetMetadata(metaclass=Metaclass_GetMetadata):
    from ouster_srvs.srv._get_metadata import GetMetadata_Request as Request
    from ouster_srvs.srv._get_metadata import GetMetadata_Response as Response
