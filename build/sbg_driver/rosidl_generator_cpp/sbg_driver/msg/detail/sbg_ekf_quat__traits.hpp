...
inline std::string to_yaml(const SbgEkfQuat & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sbg_driver::msg::SbgEkfQuat & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sbg_driver::msg::SbgEkfQuat & msg)
{
