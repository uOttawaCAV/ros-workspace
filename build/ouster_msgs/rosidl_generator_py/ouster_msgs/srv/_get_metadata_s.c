...
PyObject * ouster_msgs__srv__get_metadata__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ouster_msgs.srv._get_metadata");
...
bool ouster_msgs__srv__get_metadata__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ouster_msgs.srv._get_metadata.GetMetadata_Response", full_classname_dest, 50) == 0);
  }
  ouster_msgs__srv__GetMetadata_Response * ros_message = _ros_message;
  {  // metadata
