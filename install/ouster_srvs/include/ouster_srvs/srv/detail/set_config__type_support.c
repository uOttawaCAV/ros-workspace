...
#include <stddef.h>
#include "ouster_srvs/srv/detail/set_config__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  ouster_srvs__srv__SetConfig_Request__init(message_memory);
}

void SetConfig_Request__rosidl_typesupport_introspection_c__SetConfig_Request_fini_function(void * message_memory)
{
  ouster_srvs__srv__SetConfig_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetConfig_Request__rosidl_typesupport_introspection_c__SetConfig_Request_message_member_array[1] = {
  {
    ...
    offsetof(ouster_srvs__srv__SetConfig_Request, config_file),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers SetConfig_Request__rosidl_typesupport_introspection_c__SetConfig_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(ouster_srvs__srv__SetConfig_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, SetConfig_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  ouster_srvs__srv__SetConfig_Response__init(message_memory);
}

void SetConfig_Response__rosidl_typesupport_introspection_c__SetConfig_Response_fini_function(void * message_memory)
{
  ouster_srvs__srv__SetConfig_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetConfig_Response__rosidl_typesupport_introspection_c__SetConfig_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ouster_srvs__srv__SetConfig_Response, config),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetConfig_Response__rosidl_typesupport_introspection_c__SetConfig_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ouster_srvs__srv__SetConfig_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_ouster_srvs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, SetConfig_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_members = {
  "ouster_srvs__srv",  // service namespace
  "SetConfig",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_Request_message_type_support_handle,
  NULL  // response message
  // ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_Response_message_type_support_handle
};

static rosidl_service_type_support_t ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_type_support_handle = {
  0,
  &ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, SetConfig)() {
  if (!ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_type_support_handle.typesupport_identifier) {
    ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, SetConfig_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, SetConfig_Response)()->data;
  }

  return &ouster_srvs__srv__detail__set_config__rosidl_typesupport_introspection_c__SetConfig_service_type_support_handle;
}
