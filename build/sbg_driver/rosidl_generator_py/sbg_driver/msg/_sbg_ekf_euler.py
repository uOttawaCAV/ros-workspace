...
class Metaclass_SbgEkfEuler(type):
    """Metaclass of message 'SbgEkfEuler'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sbg_ekf_euler
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sbg_ekf_euler
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sbg_ekf_euler
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sbg_ekf_euler
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sbg_ekf_euler
...
class SbgEkfEuler(metaclass=Metaclass_SbgEkfEuler):
    """Message class 'SbgEkfEuler'."""
    ...
    _fields_and_field_types = {
        ...
        'accuracy': 'geometry_msgs/Vector3',
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Vector3
        self.angle = kwargs.get('angle', Vector3())
        from geometry_msgs.msg import Vector3
        self.accuracy = kwargs.get('accuracy', Vector3())
        from sbg_driver.msg import SbgEkfStatus
    ...
    def angle(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'angle' field must be a sub message of type 'Vector3'"
        self._angle = value
