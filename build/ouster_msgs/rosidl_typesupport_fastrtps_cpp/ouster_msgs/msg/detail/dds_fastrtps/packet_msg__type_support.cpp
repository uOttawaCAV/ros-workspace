...
#include "ouster_msgs/msg/detail/packet_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ouster_msgs::msg::PacketMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ouster_msgs::msg::PacketMsg & ros_message)
{
  // Member: buf
  {
    cdr >> ros_message.buf;
...
{
  auto typed_message =
    static_cast<const ouster_msgs::msg::PacketMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ouster_msgs::msg::PacketMsg *>(
    untyped_ros_message);
...
{
  return &ouster_msgs::msg::typesupport_fastrtps_cpp::_PacketMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_msgs, msg, PacketMsg)() {
  return &ouster_msgs::msg::typesupport_fastrtps_cpp::_PacketMsg__handle;
}
