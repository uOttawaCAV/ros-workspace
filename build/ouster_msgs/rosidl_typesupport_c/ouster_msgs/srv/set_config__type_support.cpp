...
static const _SetConfig_Request_type_support_symbol_names_t _SetConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, SetConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_msgs, srv, SetConfig_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ouster_msgs, srv, SetConfig_Request)() {
  return &::ouster_msgs::srv::rosidl_typesupport_c::SetConfig_Request_message_type_support_handle;
}
...
static const _SetConfig_Response_type_support_symbol_names_t _SetConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, SetConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_msgs, srv, SetConfig_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ouster_msgs, srv, SetConfig_Response)() {
  return &::ouster_msgs::srv::rosidl_typesupport_c::SetConfig_Response_message_type_support_handle;
}
...
static const _SetConfig_type_support_symbol_names_t _SetConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, SetConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_msgs, srv, SetConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ouster_msgs, srv, SetConfig)() {
  return &::ouster_msgs::srv::rosidl_typesupport_c::SetConfig_service_type_support_handle;
}
