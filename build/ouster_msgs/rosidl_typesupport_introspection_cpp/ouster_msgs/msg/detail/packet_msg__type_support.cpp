...
{
  new (message_memory) ouster_msgs::msg::PacketMsg(_init);
}

void PacketMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ouster_msgs::msg::PacketMsg *>(message_memory);
...
void fetch_function__PacketMsg__buf(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__PacketMsg__buf(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__PacketMsg__buf(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__PacketMsg__buf(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PacketMsg_message_member_array[1] = {
  {
    ...
    offsetof(ouster_msgs::msg::PacketMsg, buf),  // bytes offset in struct
    ...
    fetch_function__PacketMsg__buf,  // fetch(index, &value) function pointer
    assign_function__PacketMsg__buf,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PacketMsg_message_members = {
  ...
  1,  // number of fields
  sizeof(ouster_msgs::msg::PacketMsg),
...
get_message_type_support_handle<ouster_msgs::msg::PacketMsg>()
{
  return &::ouster_msgs::msg::rosidl_typesupport_introspection_cpp::PacketMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ouster_msgs, msg, PacketMsg)() {
  return &::ouster_msgs::msg::rosidl_typesupport_introspection_cpp::PacketMsg_message_type_support_handle;
}
