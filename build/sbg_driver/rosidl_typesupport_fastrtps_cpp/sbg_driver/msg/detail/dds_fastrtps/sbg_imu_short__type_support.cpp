...
#include "sbg_driver/msg/detail/sbg_imu_short__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sbg_driver::msg::SbgImuShort & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sbg_driver::msg::SbgImuShort & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sbg_driver
max_serialized_size_SbgImuShort(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const sbg_driver::msg::SbgImuShort *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sbg_driver::msg::SbgImuShort *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SbgImuShort__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sbg_driver::msg::SbgImuShort *>(
...
static size_t _SbgImuShort__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SbgImuShort(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SbgImuShort__callbacks = {
  "sbg_driver::msg",
  "SbgImuShort",
...
static rosidl_message_type_support_t _SbgImuShort__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SbgImuShort__callbacks,
...
{
  return &sbg_driver::msg::typesupport_fastrtps_cpp::_SbgImuShort__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbg_driver, msg, SbgImuShort)() {
  return &sbg_driver::msg::typesupport_fastrtps_cpp::_SbgImuShort__handle;
}
