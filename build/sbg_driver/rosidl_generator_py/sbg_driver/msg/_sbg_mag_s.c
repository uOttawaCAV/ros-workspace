...
bool sbg_driver__msg__sbg_mag__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sbg_driver.msg._sbg_mag.SbgMag", full_classname_dest, 30) == 0);
  }
  sbg_driver__msg__SbgMag * ros_message = _ros_message;
  {  // header
  ...
  {  // status
    ...
    if (!sbg_driver__msg__sbg_mag_status__convert_from_py(field, &ros_message->status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SbgMag */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sbg_driver.msg._sbg_mag");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgMag");
  ...
  {  // status
    PyObject * field = NULL;
    field = sbg_driver__msg__sbg_mag_status__convert_to_py(&ros_message->status);
    if (!field) {
      return NULL;
    }
    {
