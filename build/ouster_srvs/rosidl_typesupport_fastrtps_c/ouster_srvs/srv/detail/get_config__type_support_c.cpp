...
#include "ouster_srvs/srv/detail/get_config__rosidl_typesupport_fastrtps_c.h"
...
using _GetConfig_Request__ros_msg_type = ouster_srvs__srv__GetConfig_Request;
...
size_t get_serialized_size_ouster_srvs__srv__GetConfig_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetConfig_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_srvs__srv__GetConfig_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t max_serialized_size_ouster_srvs__srv__GetConfig_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ouster_srvs__srv__GetConfig_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetConfig_Request)() {
...
using _GetConfig_Response__ros_msg_type = ouster_srvs__srv__GetConfig_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t get_serialized_size_ouster_srvs__srv__GetConfig_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetConfig_Response__ros_msg_type * ros_message = static_cast<const _GetConfig_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_srvs__srv__GetConfig_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t max_serialized_size_ouster_srvs__srv__GetConfig_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ouster_srvs__srv__GetConfig_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetConfig_Response)() {
...
// already included above
// #include "ouster_srvs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ouster_srvs/srv/get_config.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetConfig)() {
