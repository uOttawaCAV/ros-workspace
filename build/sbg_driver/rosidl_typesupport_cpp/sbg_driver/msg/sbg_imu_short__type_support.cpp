...
static const _SbgImuShort_type_support_symbol_names_t _SbgImuShort_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbg_driver, msg, SbgImuShort)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbg_driver, msg, SbgImuShort)),
  }
};
...
{
  return &::sbg_driver::msg::rosidl_typesupport_cpp::SbgImuShort_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sbg_driver, msg, SbgImuShort)() {
  return get_message_type_support_handle<sbg_driver::msg::SbgImuShort>();
}
