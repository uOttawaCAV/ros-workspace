...
#ifndef OUSTER_SRVS__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
#define OUSTER_SRVS__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
 ...
 * calls
 * ouster_srvs__srv__GetConfig_Request__init().
...
/**
 * It calls
 * ouster_srvs__srv__GetConfig_Request__fini()
 ...
 * ouster_srvs__srv__GetConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ouster_srvs__srv__GetConfig_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ouster_srvs__srv__GetConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ouster_srvs
...
/**
 * It calls
 * ouster_srvs__srv__GetConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ouster_srvs
...
/**
 * It allocates the memory for the array and calls
 * ouster_srvs__srv__GetConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ouster_srvs
...
/**
 * It calls
 * ouster_srvs__srv__GetConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OUSTER_SRVS__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
