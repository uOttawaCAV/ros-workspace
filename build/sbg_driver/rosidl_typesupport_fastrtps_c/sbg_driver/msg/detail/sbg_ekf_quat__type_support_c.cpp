...
#include "sbg_driver/msg/detail/sbg_ekf_quat__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // accuracy
...
using _SbgEkfQuat__ros_msg_type = sbg_driver__msg__SbgEkfQuat;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SbgEkfQuat__ros_msg_type * ros_message = static_cast<const _SbgEkfQuat__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SbgEkfQuat__ros_msg_type * ros_message = static_cast<_SbgEkfQuat__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sbg_driver__msg__SbgEkfQuat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SbgEkfQuat__ros_msg_type * ros_message = static_cast<const _SbgEkfQuat__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SbgEkfQuat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sbg_driver__msg__SbgEkfQuat(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbg_driver
size_t max_serialized_size_sbg_driver__msg__SbgEkfQuat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SbgEkfQuat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sbg_driver__msg__SbgEkfQuat(
...
static message_type_support_callbacks_t __callbacks_SbgEkfQuat = {
  "sbg_driver::msg",
  "SbgEkfQuat",
...
static rosidl_message_type_support_t _SbgEkfQuat__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SbgEkfQuat,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbg_driver, msg, SbgEkfQuat)() {
  return &_SbgEkfQuat__type_support;
}
