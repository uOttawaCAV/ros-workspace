...
#include "sbg_driver/msg/detail/sbg_utc_time__rosidl_typesupport_fastrtps_c.h"
...
#include "sbg_driver/msg/detail/sbg_utc_time_status__functions.h"  // clock_status
...
using _SbgUtcTime__ros_msg_type = sbg_driver__msg__SbgUtcTime;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SbgUtcTime__ros_msg_type * ros_message = static_cast<const _SbgUtcTime__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: clock_status
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, sbg_driver, msg, SbgUtcTimeStatus
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->clock_status, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SbgUtcTime__ros_msg_type * ros_message = static_cast<_SbgUtcTime__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_sbg_driver__msg__SbgUtcTime(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SbgUtcTime__ros_msg_type * ros_message = static_cast<const _SbgUtcTime__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_sbg_driver__msg__SbgUtcTimeStatus(
...
static uint32_t _SbgUtcTime__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sbg_driver__msg__SbgUtcTime(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sbg_driver
size_t max_serialized_size_sbg_driver__msg__SbgUtcTime(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: clock_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_sbg_driver__msg__SbgUtcTimeStatus(
        full_bounded, current_alignment);
    }
  }
  // member: year
...
static size_t _SbgUtcTime__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sbg_driver__msg__SbgUtcTime(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_SbgUtcTime = {
  "sbg_driver::msg",
  "SbgUtcTime",
...
static rosidl_message_type_support_t _SbgUtcTime__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SbgUtcTime,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbg_driver, msg, SbgUtcTime)() {
  return &_SbgUtcTime__type_support;
}
