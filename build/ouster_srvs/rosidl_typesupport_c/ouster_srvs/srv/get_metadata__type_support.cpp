...
static const _GetMetadata_Request_type_support_symbol_names_t _GetMetadata_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, GetMetadata_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ouster_srvs, srv, GetMetadata_Request)() {
  return &::ouster_srvs::srv::rosidl_typesupport_c::GetMetadata_Request_message_type_support_handle;
}
...
static const _GetMetadata_Response_type_support_symbol_names_t _GetMetadata_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, GetMetadata_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_ouster_srvs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ouster_srvs, srv, GetMetadata_Response)() {
  return &::ouster_srvs::srv::rosidl_typesupport_c::GetMetadata_Response_message_type_support_handle;
}
...
static const _GetMetadata_type_support_symbol_names_t _GetMetadata_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_srvs, srv, GetMetadata)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ouster_srvs, srv, GetMetadata)() {
  return &::ouster_srvs::srv::rosidl_typesupport_c::GetMetadata_service_type_support_handle;
}
