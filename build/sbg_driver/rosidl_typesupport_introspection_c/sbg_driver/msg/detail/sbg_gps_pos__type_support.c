...
void SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_init_function(
...
void SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_fini_function(void * message_memory)
{
  sbg_driver__msg__SbgGpsPos__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_member_array[12] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_members = {
  "sbg_driver__msg",  // message namespace
  "SbgGpsPos",  // message name
  12,  // number of fields
  sizeof(sbg_driver__msg__SbgGpsPos),
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_member_array,  // message members
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_init_function,  // function to initialize message memory (memory has to be allocated)
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_type_support_handle = {
  0,
  &SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbg_driver, msg, SbgGpsPos)() {
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbg_driver, msg, SbgGpsPosStatus)();
  SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Vector3)();
  if (!SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_type_support_handle.typesupport_identifier) {
    SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SbgGpsPos__rosidl_typesupport_introspection_c__SbgGpsPos_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
