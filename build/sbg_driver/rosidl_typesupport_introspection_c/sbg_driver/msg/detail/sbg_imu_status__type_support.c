...
void SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_init_function(
...
void SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_fini_function(void * message_memory)
{
  sbg_driver__msg__SbgImuStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_member_array[10] = {
  {
    "imu_com",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_members = {
  "sbg_driver__msg",  // message namespace
  "SbgImuStatus",  // message name
  10,  // number of fields
  sizeof(sbg_driver__msg__SbgImuStatus),
  SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_member_array,  // message members
  SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_type_support_handle = {
  0,
  &SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbg_driver, msg, SbgImuStatus)() {
  if (!SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_type_support_handle.typesupport_identifier) {
    SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SbgImuStatus__rosidl_typesupport_introspection_c__SbgImuStatus_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
