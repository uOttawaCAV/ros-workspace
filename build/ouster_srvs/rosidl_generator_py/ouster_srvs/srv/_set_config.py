...
class Metaclass_SetConfig(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ouster_srvs.srv import _set_config
...
class SetConfig(metaclass=Metaclass_SetConfig):
    from ouster_srvs.srv._set_config import SetConfig_Request as Request
    from ouster_srvs.srv._set_config import SetConfig_Response as Response
