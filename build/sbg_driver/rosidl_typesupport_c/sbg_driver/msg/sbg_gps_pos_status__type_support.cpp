...
static const _SbgGpsPosStatus_type_support_symbol_names_t _SbgGpsPosStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sbg_driver, msg, SbgGpsPosStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sbg_driver, msg, SbgGpsPosStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sbg_driver, msg, SbgGpsPosStatus)() {
  return &::sbg_driver::msg::rosidl_typesupport_c::SbgGpsPosStatus_message_type_support_handle;
}
