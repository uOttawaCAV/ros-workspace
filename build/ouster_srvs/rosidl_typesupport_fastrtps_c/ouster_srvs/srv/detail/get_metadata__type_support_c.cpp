...
#include "ouster_srvs/srv/detail/get_metadata__rosidl_typesupport_fastrtps_c.h"
...
#include "ouster_srvs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _GetMetadata_Request__ros_msg_type = ouster_srvs__srv__GetMetadata_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t get_serialized_size_ouster_srvs__srv__GetMetadata_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetMetadata_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_srvs__srv__GetMetadata_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t max_serialized_size_ouster_srvs__srv__GetMetadata_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ouster_srvs__srv__GetMetadata_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata_Request)() {
...
using _GetMetadata_Response__ros_msg_type = ouster_srvs__srv__GetMetadata_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t get_serialized_size_ouster_srvs__srv__GetMetadata_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMetadata_Response__ros_msg_type * ros_message = static_cast<const _GetMetadata_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_srvs__srv__GetMetadata_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_srvs
size_t max_serialized_size_ouster_srvs__srv__GetMetadata_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ouster_srvs__srv__GetMetadata_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata_Response)() {
...
// already included above
// #include "ouster_srvs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ouster_srvs/srv/get_metadata.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_srvs, srv, GetMetadata)() {
