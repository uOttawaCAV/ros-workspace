...
#include "ouster_msgs/srv/detail/get_config__rosidl_typesupport_fastrtps_c.h"
...
using _GetConfig_Request__ros_msg_type = ouster_msgs__srv__GetConfig_Request;
...
size_t get_serialized_size_ouster_msgs__srv__GetConfig_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetConfig_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_msgs__srv__GetConfig_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_msgs
size_t max_serialized_size_ouster_msgs__srv__GetConfig_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetConfig_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ouster_msgs__srv__GetConfig_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, GetConfig_Request)() {
...
using _GetConfig_Response__ros_msg_type = ouster_msgs__srv__GetConfig_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_msgs
size_t get_serialized_size_ouster_msgs__srv__GetConfig_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetConfig_Response__ros_msg_type * ros_message = static_cast<const _GetConfig_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_msgs__srv__GetConfig_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_msgs
size_t max_serialized_size_ouster_msgs__srv__GetConfig_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetConfig_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ouster_msgs__srv__GetConfig_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, GetConfig_Response)() {
...
// already included above
// #include "ouster_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ouster_msgs/srv/get_config.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_msgs, srv, GetConfig)() {
